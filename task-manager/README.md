...
- `/task-manager/`: This is the root directory of the project.
...
Follow these minimal steps to get the project running locally (Windows PowerShell):

```powershell
git clone https://github.com/ykmuhyl/task-manager.git
cd task-manager
python -m venv venv
...
Open your browser to http://127.0.0.1:8000/ after `runserver` completes.
