...
class TaskForm(django_forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'title': django_forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'Task Title',
                'required': 'True'
            }),
            'description': django_forms.Textarea(attrs={
                'class': 'form-control',
                'placeholder': 'Task Description (optional)',
                'rows': 4
            }),
            'status': django_forms.Select(attrs={
                'class': 'form-control'
            }),
            'priority': django_forms.Select(attrs={
                'class': 'form-control'
            }),
            'due_date': django_forms.DateInput(attrs={
                'class': 'form-control',
                'type': 'date'
            }),
        }
